        ...
        <div className="w-11/12 md:w-6/12">
          ...
          <form className="flex flex-col gap-4 mt-10 " onSubmit={handleSubmit}>
            <div className="w-full">
              ...
              <input type="email" placeholder="Email" className="w-full p-3 rounded-md outline-none  text-black border border-gray-300 px-4" />
            </div>

            <div className="w-full">
              <label htmlFor="" className="block font-medium">Password</label>
              <input type="password" placeholder="Password" className="w-full p-3 rounded-md outline-none  text-black border border-gray-300 px-4" />
            </div>


            <button className=" w-full mx-auto  bg-green-500 rounded-lg p-3 mt-6 font-semibold text-lg">Login</button>
